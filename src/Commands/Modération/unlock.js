...
exports.run = async (client, message, args) => {
    ...
    try {
        ...
        return message.channel.send(`Les membres peuvent de nouveau parler dans ${targetChannel}.`);
    } catch (error) {
        console.error("Erreur lors de la modification des permissions:", error);
        return message.channel.send("Une erreur s'est produite lors de la tentative de unlock.");
    }
};
